...
export const useRaceStore = defineStore("race_information", {
        ...
        actions: {
            ...
            async loadSubRace() {
                try {
                    const response = await api.get("race/sub-race-list/" + this.race.id + "/");
            ...
            async changeSubRace(id) {
                ...
                try {
                    const response = await api.patch("race/character/" + characterStore.get_character_id + "/sub-race-change/", id);
