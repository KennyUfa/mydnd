<template>
    <div
            class="bg-white text-slate-900 border-2 border-red-600 rounded-lg p-4 max-w-7xl mx-auto">
        <div class="flex flex-row items-center border-b-2 border-red-600 pb-3 mb-4">
            <h1 class="text-xl font-bold m-0 mr-5">
                {{ character.name_champion || "-" }}</h1>
            <p class="text-sm text-slate-600 m-0 capitalize">
                {{ character.race?.name || "race" }} {{
                    character.champion_class?.name || "class"
                }}
                {{ character.level || "lvl" }}го уровня
            </p>
        </div>
        <!--базовые скилы -->
...
<!--                        Загрузка...-->
<!--                    </a>-->
<!--                    <div v-else v-for="origin in origin_list"-->
<!--                         :key="origin.id">-->
<!--                        <a-->
<!--                                class="dropdown-item"-->
<!--                                href="#"-->
