<template>
  <div class="pb-20">
    <form id="search">Search
      <input name="query" class="border-2 w-full my-3" v-model="search"/>
    </form>
      ...
      <ul class="grid grid-cols-2 md:grid-cols-3 gap-1 ">
        ...
        <li v-for="item in group" :key="item.id"
            :class="['border-2 mb-1 flex justify-between',
                        item.rarity.id=== 1 ?'bg-white border-stone-300':
                            ...
                            ?'bg-red-200 border-red-300' :
                             item.rarity.id=== 7 ?'bg-white border-stone-300':
                             item.rarity.id=== 8 ?'bg-white border-stone-300':
          ...
          <Dialog>
            ...
            >
              <Button variant="outline "
                      class="text-balance text-slate-900"
              >
                {{ item.name }}
              </Button>
            </DialogTrigger>
