...
Черта. Вы получаете одну черту на ваш выбор."""},
    ...
    features_data = [
        ...
        {"name": "ВОПЛОЩЕНИЕ АМБИЦИЙ",
         "description": """Люди, ищущие приключений, являются самыми смелыми и амбициозными представителями смелой и амбициозной расы. Они стремятся заработать славу в глазах своих товарищей, накапливая власть, богатство и популярность. Более чем другие народы люди борются за цель, а не за расширение территорий или процветание отдельных фракций."""},
        {"name": "ВТОРЫЕ ЛУЧШИЕ ДРУЗЬЯ ДЛЯ КАЖДОГО", "description": """Так же легко как они смешиваются друг с другом, люди ассимилируются с представителями других рас. Они могут ужиться почти со всеми, хотя и редко сближаются. Люди служат послами, дипломатами, магистрами, торговцами и чиновниками всех мастей.
