...
def create_human(apps, schema_editor):
    ...
    small_features_data = [
        ...
        {"name": "Возраст", "description": "Полурослики достигают зрелости к 20 годам, и обычно живут до середины своего второго столетия."},
    ...
    race.features.set(all_features)
...
"""},
    ...
    race.background.set(all_features)
    ...
    all_features = SmallFeaturesRace.objects.filter(name__in=[f["name"] for f in small_features_data])
    sub2.features.set(all_features)
