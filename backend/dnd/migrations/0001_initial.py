# Generated by Django 4.1.3 on 2023-04-21 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='scroll', to='dnd.item')),
            ],
        ),
        migrations.CreateModel(
            name='Ring',
            fields=[
                ...
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ring', to='dnd.item')),
            ],
        ),
        migrations.CreateModel(
            name='Potion',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('effects', models.CharField(max_length=255)),
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='potion', to='dnd.item')),
            ],
        ),
        migrations.AddField(
            model_name='item',
