...
from dnd.inventory.weapon import weapons
...
def combine_names(apps, schema_editor):
    ...
    for w in weapons:
        ...
        x = db_weapon.objects.create(
            type_id =db_weapon_type.objects.get(description=wep.info()[0]).id,
            name=wep.info()[1],
            damage=wep.info()[2],
        ...
        if wep.info()[7] == '':
            ...
            for i in wep.info()[7].split(','):
                if not db_weapon_properties.objects.filter(name=i.strip()):
